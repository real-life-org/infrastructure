{ config, pkgs, ... }:
{
  ...
  # Anton: Root-Zugang.
  #
  # Anders als auf timo ist das ein RSA-Schluessel ohne Hardware, nicht
  # der Nitrokey. So war es auf dem Ubuntu-System, und der Umzug soll
  # den Zustand abbilden statt ihn unbemerkt zu aendern. Auf einen
  # Hardware-Schluessel umzustellen ist eine eigene Entscheidung; bis
  # dahin haengt der Root-Zugang an einer Datei auf Antons Rechner.
